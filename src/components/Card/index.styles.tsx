...
export const Card: React.FC<CardProps> = ({ children, url }) => (
...
export const CardTitle = styled.h4<ICardTitle>`
  margin: 0.5rem 0;
...
// Card Description
interface ICardDescription extends ICardTitle {}

export const CardDescription = styled.p<ICardDescription>`
  line-height: 1.5;
  color: ${(props) => props.color || appStyles.color.black};
...
export const CardStatus: React.FC<CardStatusProps> = ({ active }) => (
  <div>
    {active ? (
...
export const CardType: React.FC<CardTypeProps> = ({ type }) => (
  <div>
    {type === 'rocket' ? (
